...
//                		""")
        		.addSystemMessage("""
        				...
        				- 바이어를 추천해 줄떄 해당 물품을 정말로 판매하고 있는 기업으로만 추천해 주세요, 진짜로 해당 물품을 판매 하고 있는 기업을 추천해줘.
        				- 정확한 명칭으로 알려주세요.
        				...
        				- "제공된 정보가 부족하여 전략 추천을 제공하기 어렵습니다. 정보가 더 많은 품목을 선택해 주세요."라고 만 답해줘.
        				- 여기서 부족한 정보는 FTA 체결국가 리스트가 부족한 정보를 말하는 거야.
        				- A국 이렇게 추천되는 경우도 "제공된 정보가 부족하여 전략 추천을 제공하기 어렵습니다. 정보가 더 많은 품목을 선택해 주세요."라고 이 한줄만 답해줘.
        				- 바이어 추천이 불가능한 경우도 "제공된 정보가 부족하여 전략 추천을 제공하기 어렵습니다. 정보가 더 많은 품목을 선택해 주세요."라고 이 한줄만 답해줘.
        				- 무엇하나 빈 정보를 줄 경우 "제공된 정보가 부족하여 전략 추천을 제공하기 어렵습니다. 정보가 더 많은 품목을 선택해 주세요."라고 이 한줄만 답해줘.
        				- '알 수 없음'같은 답을 줄 경우 "제공된 정보가 부족하여 전략 추천을 제공하기 어렵습니다. 정보가 더 많은 품목을 선택해 주세요."라고 이 한줄만 답해줘.
        				- FTA 체결 국가가 많이 있더라도 전략 추천을 하기에 정보가 부족해도 추천이 힘들다고 말해야해.
                		""")
//        		- 문장은 간결하게, 핵심만 포함합니다.  
//        		- 문장마다 개행(\n)을 넣어 가독성 좋게 작성하세요.  
